...
public class TP_Motor : MonoBehaviour {
    ...
    { 
        ...
        //TP_Controller.CharacterController.transform.localPosition += MoveVector * Time.fixedDeltaTime;
        TP_Controller.CharacterController.transform.Rotate(0, RotateVector.x * RotateSpeed, 0);
